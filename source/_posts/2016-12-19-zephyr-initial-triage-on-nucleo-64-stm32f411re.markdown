...
To not repeat documentation here please first follow [Getting Started Guide](https://www.zephyrproject.org/doc/getting_started/installation_linux.html).
...
make[1]: Entering directory '/home/pietrushnic/storage/wdc/projects/2016/workaround/zephyr_support/src/zephyr-project'
make[2]: Entering directory '/home/pietrushnic/storage/wdc/projects/2016/workaround/zephyr_support/src/zephyr-project/samples/hello_world/outdir/nucleo_f411re'
  Using /home/pietrushnic/storage/wdc/projects/2016/workaround/zephyr_support/src/zephyr-project as source for kernel
  GEN     ./Makefile
...
wrote 16384 bytes from file /home/pietrushnic/storage/wdc/projects/2016/workaround/zephyr_support/src/zephyr-project/samples/hello_world/outdir/nucleo_f411re/zephyr.bin in 0.727563s (21.991 KiB/s)
target state: halted
target halted due to debug-request, current mode: Thread
xPSR: 0x01000000 pc: 0x0800203c msp: 0x20000750
...
Done flashing
make[2]: Leaving directory '/home/pietrushnic/storage/wdc/projects/2016/workaround/zephyr_support/src/zephyr-project/samples/hello_world/outdir/nucleo_f411re'
make[1]: Leaving directory '/home/pietrushnic/storage/wdc/projects/2016/workaround/zephyr_support/src/zephyr-project'
```

## Hello world verification

Unfortunately I was not able to verify if `hello_world` example works.
